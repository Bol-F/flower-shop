...
export default function ErrorPage({
  ...
  return (
    <main className="mx-auto grid max-w-7xl place-items-center px-4 py-24 text-center">
      <div>
        <p className="text-sm font-extrabold uppercase tracking-[0.18em] text-berry">Error</p>
        <h1 className="mt-4 font-display text-3xl font-bold sm:text-4xl">Something went wrong</h1>
